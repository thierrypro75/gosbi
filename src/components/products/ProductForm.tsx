...
export default function ProductForm({ id = 'product-form', initialData, onSubmit }: ProductFormProps) {
  const {
    register,
    control,
    handleSubmit,
  ...
  return (
    <form id={id} onSubmit={handleSubmit(onSubmitForm, onError)} className="h-full">
